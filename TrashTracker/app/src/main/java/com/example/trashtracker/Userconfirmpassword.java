...
public class Userconfirmpassword extends AppCompatActivity {


    Button btnokpass;
    String url = Config.baseurl + "resetPass.php", status, error;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userconfirmpassword);

        resetPass = findViewById(R.id.etPasswordreset);
        ConfirmPass = findViewById(R.id.etPasswordconfirm);
        btnokpass = findViewById(R.id.btnokpass);
        ...
        private void loginfn () {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (status.equals("1")) {
                        Toast.makeText(Userconfirmpassword.this, "SUCCESSFULL", Toast.LENGTH_SHORT).show();
                        Intent pa = new Intent(Userconfirmpassword.this, LoginActivity.class);
                        startActivity(pa);

                    } else {

                        Toast.makeText(Userconfirmpassword.this, "INCORRECT USERNAME OR PASSWORD", Toast.LENGTH_SHORT).show();
