...
public class Add_Wastebin3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_add_wastebin3 );
        ...
        StringRequest stringRequest = new StringRequest( Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText( Add_Wastebin3.this, String.valueOf( error ), Toast.LENGTH_SHORT ).show();
                    }
                } ) {
            @Override
    ...
    private void checkLogin() {
        if (Status.equals( "0" )) {
            ...
            Intent i = new Intent( Add_Wastebin3.this, Wastebin.class );
            startActivity( i );
            finish();
