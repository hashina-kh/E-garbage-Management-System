...
public class Organizationregister extends AppCompatActivity {
    String name, email;
    String phones;
    ...
    String url = Config.baseurl + "organization_register.php", status, error;
    String ward;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_organizationregister );
        ...
        tvSignin.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ai = new Intent( Organizationregister.this, OrganizationLogin.class );
                startActivity( ai );
            }
        } );
...
//        Toast.makeText(this, otp1+"\n"+otp2, Toast.LENGTH_SHORT).show();
        ...
        StringRequest request = new StringRequest( Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (status.equals( "0" )) {
                    Toast.makeText(Organizationregister.this, "cannot register", Toast.LENGTH_SHORT ).show();
                }
                else if (status.equals( "3" )) {
                    Toast.makeText( Organizationregister.this, "Already Registered", Toast.LENGTH_SHORT ).show();
                }else {
                    Toast.makeText( Organizationregister.this, "Registered", Toast.LENGTH_SHORT ).show();
                    Intent g = new Intent( Organizationregister.this,OrganizationLogin.class );
                    startActivity( g );
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText( Organizationregister.this, "error" + error, Toast.LENGTH_SHORT ).show();
    ...
    private void checkPermission() {
        if (ContextCompat.checkSelfPermission(Organizationregister.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(Organizationregister.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        } else {
            sendOTP();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Organizationregister.this, "SMS Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
