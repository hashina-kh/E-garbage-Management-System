...
public class MemConfirmPassword extends AppCompatActivity {

    Button btnokpass;
    String url = Config.baseurl + "MemresetPass.php", status, error;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mem_confirm_password);
    ...
    private void loginfn () {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (status.equals("1")) {
                    Toast.makeText(MemConfirmPassword.this, "SUCCESSFULL", Toast.LENGTH_SHORT).show();
                    Intent pa = new Intent(MemConfirmPassword.this, Wardlogin.class);
                    startActivity(pa);

                } else {

                    Toast.makeText(MemConfirmPassword.this, "INCORRECT USERNAME OR PASSWORD", Toast.LENGTH_SHORT).show();
