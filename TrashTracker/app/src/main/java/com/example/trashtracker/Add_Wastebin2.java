...
public class Add_Wastebin2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_add_wastebin2 );
        ...
        StringRequest stringRequest = new StringRequest( Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText( Add_Wastebin2.this, String.valueOf( error ), Toast.LENGTH_SHORT ).show();
                    }
                } ) {
            @Override
    ...
    private void checkLogin() {
        if (Status.equals( "0" )) {
            ...
            Intent i = new Intent( Add_Wastebin2.this, Wastebin.class );
            startActivity( i );
            finish();
