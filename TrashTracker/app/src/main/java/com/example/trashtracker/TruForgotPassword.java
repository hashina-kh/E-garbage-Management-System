...
public class TruForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tru_forgot_password);
    ...
    public void checkPermission() {
        if (ContextCompat.checkSelfPermission(TruForgotPassword.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(TruForgotPassword.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        } else {
            sendOTP();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(TruForgotPassword.this, "", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void forgotfn() {
        ...
        if (verotp.equals(otpcheck)) {
            Intent intent = new Intent(TruForgotPassword.this, TruConfirmPassword.class);
            intent.putExtra("mobile", num);
            startActivity(intent);
        } else {
            Toast.makeText(TruForgotPassword.this, "Otp mismatch", Toast.LENGTH_SHORT).show();
        }
    }
