...
public class Add_Wastebin4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_add_wastebin4 );
        ...
        StringRequest stringRequest = new StringRequest( Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText( Add_Wastebin4.this, String.valueOf( error ), Toast.LENGTH_SHORT ).show();
                    }
                } ) {
            @Override
    ...
    private void checkLogin() {
        if (Status.equals( "0" )) {
            ...
            Intent i = new Intent( Add_Wastebin4.this, Wastebin.class );
            startActivity( i );
            finish();
