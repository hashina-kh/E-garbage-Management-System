...
public class OrgConfirmPassword extends AppCompatActivity {

    Button btnokpass;
    String url = Config.baseurl + "OrgresetPass.php", status, error;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_confirm_password);
    ...
    private void loginfn () {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (status.equals("1")) {
                    Toast.makeText(OrgConfirmPassword.this, "SUCCESSFULL", Toast.LENGTH_SHORT).show();
                    Intent pa = new Intent(OrgConfirmPassword.this, OrganizationLogin.class);
                    startActivity(pa);

                } else {

                    Toast.makeText(OrgConfirmPassword.this, "INCORRECT USERNAME OR PASSWORD", Toast.LENGTH_SHORT).show();
