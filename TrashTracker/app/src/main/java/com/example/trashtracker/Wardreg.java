...
public class Wardreg extends AppCompatActivity {
    Spinner spin;
    ...
    String url = Config.baseurl + "ward_register.php", status, error;
    String ward;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_wardreg );
        spin = findViewById( R.id.spin );
        ArrayAdapter<String> adapter = new ArrayAdapter<>( Wardreg.this, R.layout.support_simple_spinner_dropdown_item, t );
        ...
        tvSignin.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ai = new Intent( Wardreg.this, Wardlogin.class );
                startActivity( ai );
            }
        } );
...
//        Toast.makeText(this, otp1+"\n"+otp2, Toast.LENGTH_SHORT).show();
    ...
    StringRequest request = new StringRequest( Request.Method.POST, url, new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            ...
            if (status.equals( "0" )) {
                Toast.makeText( Wardreg.this, "cannot register", Toast.LENGTH_SHORT ).show();
            }
           else if (status.equals( "3" )) {
                Toast.makeText( Wardreg.this, "Already Registered", Toast.LENGTH_SHORT ).show();
            }else {
                Toast.makeText( Wardreg.this, "Registered", Toast.LENGTH_SHORT ).show();
                Intent g = new Intent( Wardreg.this,Wardlogin.class );
                startActivity( g );
            }
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            Toast.makeText( Wardreg.this, "error" + error, Toast.LENGTH_SHORT ).show();
    ...
    public void checkPermission() {
        if (ContextCompat.checkSelfPermission(Wardreg.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(Wardreg.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        } else {
            sendOTP();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Wardreg.this, "SMS Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
