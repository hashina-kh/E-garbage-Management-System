...
public class MemForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mem_forgot_password);
    ...
    public void checkPermission() {
        if (ContextCompat.checkSelfPermission(MemForgotPassword.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(MemForgotPassword.this, new String[]{Manifest.permission.SEND_SMS}, 1);
        } else {
            sendOTP();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(MemForgotPassword.this, "", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void forgotfn() {
        ...
        if (verotp.equals(otpcheck)) {
            Intent intent = new Intent(MemForgotPassword.this, MemConfirmPassword.class);
            intent.putExtra("mobile", num);
            startActivity(intent);
        } else {
            Toast.makeText(MemForgotPassword.this, "Otp mismatch", Toast.LENGTH_SHORT).show();
        }
    }
