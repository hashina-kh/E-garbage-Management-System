...
public class CollectAdapter extends RecyclerView.Adapter<CollectAdapter.MyViewHolder> {
   ...
   String url=Config.baseurl+"updatestatus.php";
    ...
    public CollectAdapter(Collected_List collected_list, ArrayList<Reportdatamodel> reportdatamodelArrayList) {

        this.reportdatamodelArrayList=reportdatamodelArrayList;
        this.context=collected_list;
        inflator=LayoutInflater.from(context);

    }
    @NonNull
    @Override
    public CollectAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v =inflator.inflate(R.layout.collect, parent, false);
        CollectAdapter.MyViewHolder holder = new CollectAdapter.MyViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CollectAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
