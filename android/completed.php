<?php
	...
	$stmt = $conn->prepare("SELECT id,name,location,description,wid,type,mid,ward,userid,status,driverid,drivername,date,time FROM waste_report where  status='completed' ");
