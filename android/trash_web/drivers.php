...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>E-Garbage Management System Admin</title>
	<!--
		CSS
		============================================= -->
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="drivers.php">Drivers</a></li>
			...
			<div class="row">
			    ...
			    <table border="1" align="center"> 
                                ...
                                include('config.php');
                              	...
                              	$query1="select * from truckdriver";
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="approve_driver.php?id=<?php echo $id;?>"><li class="btn header-btn">Approve</li></a></td>
                                        <td><a href="delete_driver.php?id=<?php echo $id;?>"><li class="btn header-btn">Delete</li></a></td>
                                        <!-- <td><a href="assign_vol.php?id=<?php echo $id;?>&name=<?php echo $name;?>"><li class="btn header-btn">Assign</li></a></td> -->
                                        </tr>
                                    <?php
                    	        }
                                ?>
