				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="complaints.php">Complaints</a></li>
		...
		<div class="container">
			...
			<table border="1" align="center"> 
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                 ...
                                 //    $query="select name from registration where id = '$user_id' ";
                    	            // $res=mysqli_query($conn, $query) or die("error".mysqli_error());
