				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="wastebins.php">Wastebins</a></li>
            			...
            			<table border="1" align="center"> 
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $type;?></td>
                                        <td><a href="delete_wastebin.php?id=<?php echo $id;?>"><li class="btn header-btn">Delete</li></a></td>
                                        </tr>
                                    <?php
                    	        }
                                ?>
