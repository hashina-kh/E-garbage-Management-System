				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="Collected_list.php">Collected List</a></li>
				...
				<div class="col-lg-6 text-center">
					<div class="section-title">
            			...
            			<table border="1" align="center"> 
                                ...
                                <td><h4>Wastebin</h4></td>
                                <td><h4>Ward</h4></td>
                                <td><h4>Status</h4></td>
                                <td><h4>Drivername</h4></td>
                                <td><h4>Date</h4></td>
                                <td><h4>Time</h4></td>
                                </tr>     
                                ...
                                include('config.php');
                              	...
                              	$query1="select * from waste_report where status='collected'";
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                         ...
                                         $sql = "select * from truckdriver where id='$driverid'";
